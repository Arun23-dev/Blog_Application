...
const SinglePostPage = () => {
    ...
    return (
        <div className="flex flex-col gap-8">
            {/* detail */}
            <p>Here is single post page ok </p>
            <div className="flex gap-8">
                <div className="lg:w-3/5 flex flex-col gap-8">
                    <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
                        I  am hero dolorem, dolores eligendi amet perferendis illum repellat nam quam
                    ...
                    <p className="text-gray-500 font-medium">I am hero</p>
                </div>

                <div className="hidden lg:block w-2/5">
                    <Image
                        src="./logo.png"
                        className=" object-cover rounded-2xl w-8/10 h-[300px]"
                        alt="Post Image"
                    />
                </div>
                ...
                <div className="px-4 h-max sticky top-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-8">
                            ...
                            <Link className="text-blue-800">I am hero</Link>
                        </div>
